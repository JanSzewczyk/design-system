...
export function AlertDialogContent({ className, ...props }: AlertDialogContentProps) {
  return (
    <ReactAlertDialog.Portal>
      <ReactAlertDialog.Overlay className="bg-app-background/80 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 backdrop-blur-xs fixed inset-0 z-50" />
