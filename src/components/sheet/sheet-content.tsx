  ...
  return (
    <ReactSheet.Portal>
      ...
      <ReactSheet.Content className={cn(sheetContentStyles({ side }), className)} {...props}>
        {children}
        <ReactSheet.Close className="focus:ring-ring ring-primary-500 ring-offset-app-foreground data-[state=open]:bg-app-foreground absolute right-4 top-4 rounded-sm opacity-70 transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:pointer-events-none">
          <X className="size-4" />
